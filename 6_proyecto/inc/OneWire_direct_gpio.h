...
#define IO_REG_TYPE int32_t
#define IO_REG_BASE_ATTR
#define IO_REG_MASK_ATTR
#define DIRECT_MODE_INPUT(base,pin)    gpioInit((gpioMap_t)(pin),GPIO_INPUT)
#define DIRECT_READ(base,pin)          gpioRead((gpioMap_t)(pin))
#define DIRECT_MODE_OUTPUT(base,pin)   gpioInit((gpioMap_t)(pin),GPIO_OUTPUT)
#define DIRECT_WRITE_LOW(base,pin)     gpioWrite((gpioMap_t)(pin), LOW)
#define DIRECT_WRITE_HIGH(base,pin)    gpioWrite((gpioMap_t)(pin), HIGH)
